package com.example.testingrecyclerview.Fragments
...
import com.example.testingrecyclerview.adapter.PeopleAdapter
...
class FirstNavFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val person1 = Person("Jorge")
        val person2 = Person("Fede")
        val person3 = Person("Ariel")

        val people = listOf<Person>(person,person1,person2,person3)
